...
def parse_args():
    parser = argparse.ArgumentParser(description='Train AOI Classifier')
    parser.add_argument('--train_directory', type=str, required=False,
                        default='/home/dong9/PycharmProjects/Pedestrain_Study/Data/train',
    ...
    parser.add_argument('--use_weighting', type=bool, required=False, default=False,
                        help="use weighted cross entropy or not")
...
def main():
    ...
    if not os.path.isfile('train_performance.csv'):
        with open('train_performance.csv', mode='w') as csv_file:
            fieldnames = ['Index', 'Model', 'Training Time', 'Trainable Parameters', 'Best Train Acc',
                          'Best Train Epoch',
    ...
    if args.use_weighting:
        ...
        weights = [2.04862, 10.045, 4.3898, 7.2268, 1.4, 5.71788, 2.26562, 8.6434, 3.46892, 12.10076, 4.6458, 4.765,
                   18.2787, 15.4861, 3.46122]  # 1.4 times
